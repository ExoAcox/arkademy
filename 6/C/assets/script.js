...
document.getElementById("table").addEventListener("click", event => {
    ...
    document.getElementById("id_pro").value = event.target.parentElement.parentElement.querySelector(".xid_pro").textContent
    document.getElementById("id_del").value = event.target.parentElement.parentElement.querySelector(".xid_pro").textContent
    document.getElementById("id_cas").value = event.target.parentElement.parentElement.querySelector(".xid_cas").textContent
...
// Popup window (add)
function add() {
    popup.querySelector("form").setAttribute("action", "pages/add.php")
